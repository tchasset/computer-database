insert into users (username,password,enabled, role) values ('admin','$2y$10$ygq6xZmWe1pYcq9ico4GE.r2zlDlo5JHf8IooIAbRCWL37nAAbeki',1 ,'ADMIN' );
insert into users (username,password,enabled, role) values ('user','$2y$10$/cKdz6OOxOAeMkpADOzgceZ9/JUhJMtzy0dFXQZE6Rps5kN/ypWdy',1 ,'USER');
...
insert into computer (id,name,introduced,discontinued,company_id) values (575,'PC to edit','2020-08-5',null,null);
insert into computer (id,name,introduced,discontinued,company_id) values (576,'PC to delete 1','2020-08-4',null,2);
insert into computer (id,name,introduced,discontinued,company_id) values (577,'PC to delete 2','2020-08-3',null,5);
insert into computer (id,name,introduced,discontinued,company_id) values (578,'PC to delete 3','2020-08-2',null,7);
