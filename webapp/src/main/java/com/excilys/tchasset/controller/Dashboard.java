...
public class Dashboard {
	...
	public ModelAndView dashboard(PaginationDTO paginationDTO) {
		...
		page.setSize(Integer.parseInt(paginationDTO.getSize()));
		page.setCurrentPage(Integer.parseInt(paginationDTO.getCurrentPage()));
		...
		if(!paginationDTO.getSearch().isEmpty()) {
			...
			if(paginationDTO.getOrderByName()!=null && (paginationDTO.getOrderByName().equals("ASC") || paginationDTO.getOrderByName().equals("DESC")))
				computerList.addAll(computerService.getComputersOrderByComputer(page, paginationDTO.getOrderByName(),paginationDTO.getSearch()));
				...
				computerList.addAll(computerService.getComputersOrderByCompany(page, paginationDTO.getOrderByCompany(), paginationDTO.getSearch()));
			else
