insert into users (username,password,enabled) values ('admin','$2y$10$ygq6xZmWe1pYcq9ico4GE.r2zlDlo5JHf8IooIAbRCWL37nAAbeki',1);
insert into users (username,password,enabled) values ('user','$2y$10$/cKdz6OOxOAeMkpADOzgceZ9/JUhJMtzy0dFXQZE6Rps5kN/ypWdy',1);
